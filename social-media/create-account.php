          ...
          <div class="card" style="border-radius: 1rem;">
            <div class="row g-0">
              <div class="col-md-6 col-lg-5 d-none d-md-block">
                <img src="assets/images/login_request/signup_img.jpg" alt="login form" class="img-fluid"
              ...
              <div class="col-md-6 col-lg-7 d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  <form method="post" id="signup_form" action="signup_process.php">
                    ...
                    <p class="mb-4 pb-lg-2" style="color: #19afd4;">Have an account? <a href="login.php"
                        style="color: #2696ca;">SignIn</a></p>
                  </form>
                </div>
              </div>
            </div>
